  ...
  return (
    <div className="max-w-md mx-auto py-16 text-center space-y-6">
      ...
      <div className="space-y-2">
        <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Agent Bus Portal</h2>
        <p className="text-sm text-slate-500 max-w-sm mx-auto">
          We are currently integrating with local and national transit operators. Soon you will be able to book bus tickets and earn commission.
        </p>
      </div>
      <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-6 text-sm text-left space-y-3">
        ...
        <ul className="space-y-2 text-slate-600 list-disc pl-4">
          <li>Commission-earning route options</li>
          <li>Live seat layout selection</li>
          <li>Real-time vehicle tracking features</li>
          <li>Instant booking validation</li>
        </ul>
      </div>
